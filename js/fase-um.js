...
if (isMobile) {
  ...
  tutorial.innerHTML = `➡️ Use as setas para se mover até o pescador <br>`;
}
...
document.addEventListener('keydown', (evento) => {
  ...
  if (evento.code === 'ArrowRight' || evento.code === 'ArrowLeft') {
    ...
    if (evento.code === 'ArrowRight') posicaoX += velocidade;
    else if (evento.code === 'ArrowLeft') posicaoX -= velocidade;
  } 
